...
const NewGamePage = () => {
  ...
  const handleStatsWorkload = (value) => {
    setStatsLoader(true);
    postStatsWorkload({ team_id: value, date_key: "2024-07-14" })
      .then((resStat) => {
        setStatsLoader(false);
        setStatsworkload(resStat);
  ...
  //   useEffect(() => {
  //    console.log(opp_team, performance)
  //   }, [opp_team, performance]);
                  ...
                  {weather?.data?.Game_Temp?.[index] ? (
                    <div className="grid grid-cols-3 mt-5 weather-text">
                      ...
                      <div className="text-center weather-text2">
                        ...
                        <h1 className="font-medium text-center leading-none chance-text text-4xl my-2">
                          Chance of{" "}
                          <span className="chance-texts"> precip </span>
                        </h1>
                      </div>
                      <div className="text-center flex justify-center weather-text3">
                        <DirectionImage
                          newclass="newclass"
                          windDir={
                            weather?.data?.Game_Wind_Dir_SVG_Rotate?.[index]
                          }
                      ...
                      <tbody className="table-body">
                        <tr>
                          <th className="text-left px-5 sticky-col-weather">
                            {weather?.data?.GH_N2_Time?.[index] &&
                            weather?.data?.GH_N2_Time?.[index] !== "DOMS"
                              ? weather?.data?.GH_N2_Time?.[index]
                              : " "}
                          </th>
                          ...
                          <td className="text-center px-5">
                            ...
                            weather?.data?.GH_N2_Wind_Dir?.[index] !== "DOMS"
                              ? weather?.data?.GH_N2_Wind_Dir?.[index]
                              : " "}
                          </td>
                        ...
                        <tr className="border-b-2">
                          <th className="text-left  px-5 sticky-col-weather">
                            ...
                            weather?.data?.GH_N1_Time?.[index] !== "DOMS"
                              ? weather?.data?.GH_N1_Time?.[index]
                              : " "}
                          </th>
                          <td className="text-center px-5">
                          ...
                          <td className="text-center px-5">
                            ...
                            weather?.data?.GH_N1_Wind_Dir?.[index] !== "DOMS"
                              ? weather?.data?.GH_N1_Wind_Dir?.[index]
                              : " "}
                          </td>
                          <td className="text-center px-5">
                        ...
                        <tr>
                          <th className="text-left px-5 sticky-col-weather">
                            ...
                            weather?.data?.GH_1_Time?.[index] !== "DOMS"
                              ? weather?.data?.GH_1_Time?.[index]
                              : " "}
                          </th>
                          <td className="text-center px-5">
                          ...
                          <td className="text-center px-5">
                            ...
                            weather?.data?.GH_1_Wind_Dir?.[index] !== "DOMS"
                              ? weather?.data?.GH_1_Wind_Dir?.[index]
                              : " "}
                          </td>
                          <td className="text-center px-5">
                        ...
                        <tr>
                          <th className="text-left px-5 sticky-col-weather">
                            ...
                            weather?.data?.GH_2_Time?.[index] !== "DOMS"
                              ? weather?.data?.GH_2_Time?.[index]
                              : " "}
                          </th>
                          <td className="text-center px-5">
                          ...
                          <td className="text-center px-5">
                            ...
                            weather?.data?.GH_2_Wind_Dir?.[index] !== "DOMS"
                              ? weather?.data?.GH_2_Wind_Dir?.[index]
                              : " "}
                          </td>
                          <td className="text-center px-5">
                        ...
                        <tr>
                          <th className="text-left px-5 sticky-col-weather">
                            ...
                            weather?.data?.GH_3_Time?.[index] !== "DOMS"
                              ? weather?.data?.GH_3_Time?.[index]
                              : " "}
                          </th>
                          <td className="text-center px-5">
                          ...
                          <td className="text-center px-5">
                            ...
                            weather?.data?.GH_3_Wind_Dir?.[index] !== "DOMS"
                              ? weather?.data?.GH_3_Wind_Dir?.[index]
                              : " "}
                          </td>
                          <td className="text-center px-5">
                        ...
                        <tr>
                          <th className="text-left px-5 sticky-col-weather">
                            ...
                            weather?.data?.GH_4_Time?.[index] !== "DOMS"
                              ? weather?.data?.GH_4_Time?.[index]
                              : " "}
                          </th>
                          <td className="text-center px-5">
                          ...
                          <td className="text-center px-5">
                            ...
                            weather?.data?.GH_4_Wind_Dir?.[index] !== "DOMS"
                              ? weather?.data?.GH_4_Wind_Dir?.[index]
                              : " "}
                          </td>
                          <td className="text-center px-5">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td className="bg-white text-black text-center  border-r-2 border-black">
                                {statsworkload?.away_stats?.[0]?.L14_ERA}
                              </td>
                              <td className="bg-white text-black text-center border-r-2 border-black">
                                {statsworkload?.away_stats?.[0]?.L30_ERA}
                              </td>
                              <td className="bg-white text-black text-center border-r-2 border-black">
                                {statsworkload?.away_stats?.[0]?.YTD_ERA}
                              </td>
                            </tr>
                            <tr>
                              <td className="font-bold text-left">WHIP</td>
                              <td className="bg-white text-black text-center border-r-2 border-black">
                                {statsworkload?.away_stats?.[0]?.L14_WHIP}
                              </td>
                              <td className="bg-white text-black text-center border-r-2 border-black">
                                {statsworkload?.away_stats?.[0]?.L30_WHIP}
                              </td>
                              <td className="bg-white text-black text-center border-r-2 border-black">
                                {statsworkload?.away_stats?.[0]?.YTD_WHIP}
                              </td>
                            </tr>
                            <tr>
                              <td className="font-bold text-left">Ks/Game</td>
                              <td className="bg-white text-black text-center border-r-2 border-black">
                                {statsworkload?.away_stats?.[0]?.L14_K_PerGame}
                              </td>
                              <td className="bg-white text-black text-center border-r-2 border-black">
                                {statsworkload?.away_stats?.[0]?.L30_K_PerGame}
                              </td>
                    ...
                    <div className="rounded-3xl w-full py-5 mt-10 px-10 bullpen-cards bg-[#fdcf2b] ">
                      ...
                      <div className="mt-20 mb-5 p-2 lg:w-[98%] md:max-w-[70vw] m-auto table-outer-section overflow-x-auto">
                        <div className="table-container">
                          <table className="w-full bg-white table2">
                            <thead className="table-header">
                              <tr>
                              ...
                              <tr className="border-b-2 py-4">
                                {columns1?.length > 0
                                  ? columns1.map((item, index) => (
                                      <th
                                        className={`text-center capitalize px-5 ${
                            ...
                            <tbody className="table-body workload-data">
                              {segmentData?.length > 0
                                ? segmentData.map((item, i) => (
                                    <tr className="border-b-2 py-3" key={i}>
                                      <td className="text-center work-data px-5 sticky-col">
                                        {item?.[`${columns1?.[0]}`]}
                                      </td>
                                      <td
