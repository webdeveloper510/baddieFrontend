  ...
  const keypoints = [
    {
      ...
      content:
        "Maximize your returns by relying on tools from expert data scientists who know what you need to consistently make valuable sports picks, efficiently.",
    },
    {
      image: "/bet4.png",
      heading: "The EV Calculator",
      content:
        "Gives you the power of Poisson distributions at your fingertips. Easily pull up matchups and find mispriced lines for positive expected value.",
    },
    {
      image: "/bet2.png",
      heading: "Player Segment Models",
      content:
        "Use state of the art clustering algorithms to learn more about individual players & apply hidden insights for future performance prediction.",
    },
    {
      image: "/bet3.png",
      heading: "Player & Team EDA Dashboard",
      content:
        "Visualize performance for teams and players for fast, intuitive analysis.",
    },
    {
      image: "/bet5.png",
      heading: "High Quality Sports PIcks",
      content:
        "From experienced handicappers, using our tools & expertise to make sharp decisions.",
    },
    {
      image: "/bet6.png",
    ...
    <>
      <div className="top_banner border-black py-5 px-5 mb-20 fullwidth mx-auto  h-auto ">
        <div className="text-center">
          <h1 className="tryna_link_one">
            <span>Bet</span> like a data scientist
          </h1>
        </div>
        {!user && (
          <>
      ...
      <div className="section2">
        <div className="container m-auto">
          <div className="flex items-center bets-section">
            ...
            <div className="col-6">
              <h1 className="text-white text-4xl font-bold sec2heading tryna_link_btn_big">
                YTD MLB Pick Stats
              </h1>
              <p>
                $100 unit bettors have made ${Math.floor(picks?.units * 100)}{" "}
                year to date so far with BADDIE’s picks
              </p>
              ...
              <div className="w-full btn-row">
                <button className="text-black  bg-lightgray text-lg  w-40  button new_heading_btn">
                  <a
      ...
      <div className="section3">
        <div className="container m-auto">
          <div className="p-4 text-center">
            <h1 className="Ballers_btn">MLB Ballers</h1>
          </div>
          {graph &&
            graph.map((item, i) => (
              <div
                key={i}
                className={` flex row items-center justify-center graph-row ${
                  loading ? "hidden" : ""
                }`}
              >
                <div className="col-6">
        ...
        <div className="container m-auto">
          <div className="bets-container">
            {keypoints.map((item, index) => (
              <div
                key={index}
                className={` flex row items-center justify-center bet-row`}
              >
                <div className="col-6">
